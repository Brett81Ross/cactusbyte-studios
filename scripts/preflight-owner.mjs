...
check((testerPass.match(/[a-f0-9]{64}/g)||[]).length===10&&testerPass.includes("timingSafeEqual"),"Exactly ten tester coupon hashes are staged and verified without storing raw coupon codes");
